...
public static class ResultFunctionality
{
    ...
    public static Result<R, E> Bind<E, R>(this Result<E> res, Func<Result<R, E>> onSuccess) where E : Error
        => res.Success ? onSuccess() : res.Error;
    public static Result<R, OE> Bind<E, R, OE>(this Result<E> res, Func<Result<R, OE>> onSuccess, Func<E, Result<R, OE>> onFail) where E : Error where OE : Error
        => res.Success ? onSuccess() : onFail(res.Error);

    public static Result<R, E> Map<E, R>(this Result<E> res, Func<R> onSuccess, Func<E, R>? onFail = null) where E : Error
